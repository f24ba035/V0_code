...
export default function YoutubeFaq() {
  const faqs = [
    {
    ...
    },
    {
      ...
      answer:
        "A. 1ヶ月ほどで対応いたします。初回撮影後、2週間〜1ヶ月ほどお時間いただきます。ご希望に合わせて柔軟に対応できればと考えております。",
    },
  ]

  return (
    <section id="YouTube-faq" className="py-16 md:py-24 bg-[#fffefe]">
